package uz.example.mvpproject.adapter
...
import uz.example.mvpproject.activity.DetailsActivity
import uz.example.mvpproject.activity.EditActivity
import uz.example.mvpproject.activity.MainActivity
...
class PostAdapter(val activity: MainActivity, val items:ArrayList<Post>) : RecyclerView.Adapter<PostAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        delete.setOnClickListener {
            activity.pb_loading.visibility = View.VISIBLE
            deletePostDialog(post)
        }
